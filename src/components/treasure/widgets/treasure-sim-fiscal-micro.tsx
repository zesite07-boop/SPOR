...
export function TreasureSimFiscalMicro({
  ...
  return (
    <div className={cn("space-y-4", hyperfocus && "space-y-3")}>
      <p className="text-xs leading-relaxed text-padma-night/68 dark:text-padma-cream/72">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div>
          ...
          <button
            type="button"
            className="mt-2 text-[0.7rem] text-padma-pearl underline decoration-padma-champagne/50 underline-offset-2 hover:text-padma-night dark:text-padma-lavender/85 dark:hover:text-padma-cream"
      ...
      <div className="grid gap-3 rounded-xl border border-padma-lavender/15 bg-white/55 px-4 py-3 sm:grid-cols-3 dark:border-padma-lavender/12 dark:bg-padma-night/45">
        <div>
          <p className="text-[0.65rem] uppercase tracking-wide text-padma-pearl dark:text-padma-lavender/80">Base imposable approx.</p>
          <p className="font-cinzel text-lg text-padma-night dark:text-padma-cream">{eur(snap.baseImposableApproxEuro)}</p>
        </div>
        <div>
          <p className="text-[0.65rem] uppercase tracking-wide text-padma-pearl dark:text-padma-lavender/80">Charges sociales approx.</p>
          <p className="font-cinzel text-lg text-padma-night dark:text-padma-cream">{eur(snap.socialChargesApproxEuro)}</p>
        </div>
        <div>
          <p className="text-[0.65rem] uppercase tracking-wide text-padma-pearl dark:text-padma-lavender/80">Après charges (approx.)</p>
          <p className="font-cinzel text-lg text-padma-night dark:text-padma-cream">{eur(snap.netAfterSocialApproxEuro)}</p>
        </div>
      </div>
    </div>
  );
